...
namespace MyMLAppML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\DEV\MLNetTutorial\myMLApp\Dependancies\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\Admin\AppData\Local\Temp\MLVSTools\myMLAppML\myMLAppML.Model\MLModel.zip";
